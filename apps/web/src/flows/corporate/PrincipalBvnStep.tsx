...
export function CorporatePrincipalBvnStep({
  onContinue,
  renderShell,
}: {
  onContinue: () => void;
  ...
  return renderShell({
    ...
    children: (
      <form id="corporate-bvn-form" onSubmit={onSubmit} className="grid gap-4">
        <Field
          label="BVN"
          name="bvn"
          inputMode="numeric"
        ...
        />
        <ContextualHelp>
          The principal’s BVN links the business registration to a verified
          individual director or owner.
        </ContextualHelp>
        <Field
          label="Date of birth"
          name="dateOfBirth"
